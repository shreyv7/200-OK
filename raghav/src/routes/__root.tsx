  ...
  head: () => ({
    meta: [
      ...
      { title: "Trellis — An agentic growth curator" },
      {
        name: "description",
        content:
          "Trellis measures the gap between your declared self and your revealed behaviour, then curates a daily identity stack to close it.",
      },
      { name: "author", content: "Trellis" },
      { property: "og:title", content: "Trellis — An agentic growth curator" },
      {
        property: "og:description",
        content:
          "Measure the gap between who you say you want to become and what your behaviour shows.",
      },
